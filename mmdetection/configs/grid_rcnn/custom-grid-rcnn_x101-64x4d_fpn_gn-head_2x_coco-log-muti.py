...
data_root = '/work/van-speech-nlp/jindaznb/j-vis/Forestfire2024-1-log' # Root directory of the dataset
...
test_dataloader = dict(
    dataset=dict(
        data_root='/work/van-speech-nlp/jindaznb/j-vis/Forestfire2024-1-log',
    ),)
test_evaluator = dict(
    ann_file='/work/van-speech-nlp/jindaznb/j-vis/Forestfire2024-1-log/valid/_annotations.coco.json',)
...
val_evaluator = dict(
    ann_file=
    '/work/van-speech-nlp/jindaznb/j-vis/Forestfire2024-1-log/valid/_annotations.coco.json',
)
