...
data_root = '/work/van-speech-nlp/jindaznb/j-vis/ForestFire2023-5-linear' # Root directory of the dataset
...
test_dataloader = dict(
    dataset=dict(
        data_root='/work/van-speech-nlp/jindaznb/j-vis/ForestFire2023-5-linear',
    ),)
test_evaluator = dict(
    ann_file='/work/van-speech-nlp/jindaznb/j-vis/ForestFire2023-5-linear/valid/_annotations.coco.json',)
...
val_evaluator = dict(
    ann_file=
    '/work/van-speech-nlp/jindaznb/j-vis/ForestFire2023-5-linear/valid/_annotations.coco.json',
)
